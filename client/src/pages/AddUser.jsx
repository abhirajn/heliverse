...
export default function AddUser() {
   ...
   const handleSubmit = async(e)=>{
    ...
    await axios.post('https://heliverse-backend-xxxd.onrender.com/api/users' , {"obj" : obj});
     setFirst("");
     setLast("");
     setAva("");
     setMail("");
...
<form className='m-4 md:m-8 lg:m-12 w-full lg:w-2/4 border-2  border-black p-6'>
<div className='m-4 text-center text-blue-600 text-3xl font-mono antialiased font-bold'><p>Enter Details of User:</p></div>
...
<div className="flex items-center">
    ...
    checked id="default-radio-2" type="radio" value="" name="default-radio" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
