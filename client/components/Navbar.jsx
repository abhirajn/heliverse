        ...
        <div className='flex float-left'>
         ...
         <div className='flex justify-end p-2'>
          ...
          <ul className='md:flex lg:flex hidden '>
            <li className=''> <button className='font-mono text-xl rounded-3xl hover:bg-blue-300 px-3 py-2 lg:px-5 md:text-xl md:px-2' >Home</button></li>
            <li className=''> <button className='font-mono text-xl rounded-3xl hover:bg-blue-300 px-3 py-2 lg:px-5 md:text-xl md:px-2'>Add_User</button></li>
            <li className=''> <button className='font-mono text-xl rounded-3xl hover:bg-blue-300 px-3 py-2 lg:px-5 md:text-xl md:px-2' >Create_Team</button></li>
